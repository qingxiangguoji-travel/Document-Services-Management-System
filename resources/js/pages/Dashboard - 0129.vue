...
const goOrders = (query = {}) => {
  router.push({ name: 'business.orders', query })
}
const todayCards = computed(() => [
  {
    ...
    bgColor: '#dbeafe',
    iconColor: '#2563eb',
    click: () => goOrders({ dateRange: `${todayStr()},${todayStr()}` })
  },
  {
    label: '今日业务数',
  ...
  },
  {
    ...
    bgColor: '#fee2e2',
    iconColor: '#dc2626',
    click: () => goOrders({ dateRange: `${todayStr()},${todayStr()}`, processStatus: 'unfinished' })
  },
  {
    label: '今日办理中',
    ...
    bgColor: '#fef3c7',
    iconColor: '#d97706',
    click: () => goOrders({ dateRange: `${todayStr()},${todayStr()}`, processStatus: 'processing' })
  },
  {
    label: '今日已完成',
    ...
    bgColor: '#dcfce7',
    iconColor: '#16a34a',
    click: () => goOrders({ dateRange: `${todayStr()},${todayStr()}`, processStatus: 'completed' })
  },
  {
    label: '今日已取消',
    ...
    bgColor: '#fee2e2',
    iconColor: '#b91c1c',
    click: () => goOrders({ dateRange: `${todayStr()},${todayStr()}`, processStatus: 'cancelled' })
  },
  {
    label: '今日已送回',
    ...
    bgColor: '#f1f5f9',
    iconColor: '#334155',
    click: () => goOrders({ dateRange: `${todayStr()},${todayStr()}`, processStatus: 'returned' })
  }
])
...
const historyCards = computed(() => [
  ...
  },
  {
    ...
    bgColor: '#fee2e2',
    iconColor: '#dc2626',
    click: () => goOrders({ processStatus: 'unfinished' })
  },
  {
    label: '历史办理中',
    ...
    bgColor: '#fef3c7',
    iconColor: '#d97706',
    click: () => goOrders({ processStatus: 'processing' })
  },
  {
    label: '历史已完成',
    ...
    bgColor: '#dcfce7',
    iconColor: '#16a34a',
    click: () => goOrders({ processStatus: 'completed' })
  },
  {
    label: '历史已取消',
    ...
    bgColor: '#fee2e2',
    iconColor: '#b91c1c',
    click: () => goOrders({ processStatus: 'cancelled' })
  },
  {
    label: '历史已送回',
    ...
    bgColor: '#f1f5f9',
    iconColor: '#334155',
    click: () => goOrders({ processStatus: 'returned' })
  }
])
